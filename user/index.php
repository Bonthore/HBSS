                ...
                <div class="col-sm-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="activities">
                            <?php
                            $hummingbird = json_decode(getJson("http://hummingbird.me/api/v1/users/". $otheruser["name"] ."/feed"), true);
                            $i=0;
                                            ...
                                            <div class="table-responsive">
                                                <div id="table2_wrapper" class="dataTables_wrapper" role="grid">
                                                    <table class="table dataTable" id="table2" aria-describedby="table2_info">
                                                        ...
                                                        <?php
                                                        $hummingbird = json_decode(getJson("http://hummingbird.me/api/v1/users/". $otheruser["name"] ."/library"), true);
                                                        $i=0;
                                                        while ($i<count($hummingbird)){
