...
if (strpos($_SERVER['REQUEST_URI'], "/watch") !== false){
    $watch_active = ' class="active"';
}
if (strpos($_SERVER['REQUEST_URI'], "/listen") !== false){
    $listen_active = ' class="active"';
}
if (strpos($_SERVER['REQUEST_URI'], "/profile") !== false){
    $profile_active = ' class="active"';
}
if (strpos($_SERVER['REQUEST_URI'], "/feed") !== false){
    $feed_active = ' class="active"';
}
...
<div class="leftpanel">
    ...
    <div class="leftpanelinner">
        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
            <li<?php echo $home_active;?>><a href="/"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
            <li<?php echo $watch_active;?>><a href="/watch"><i class="fa  fa-play"></i> <span>Watch</span></a></li>
            <li<?php echo $listen_active;?>><a href="/listen"><i class="fa fa-music"></i> <span>Listen</span></a></li>
            <li<?php echo $profile_active;?>><a href="/profile"><i class="fa fa-user"></i> <span>Profile</span></a></li>
            <li<?php echo $feed_active;?>><a href="/feed"><i class="fa fa-rss"></i> <span>Feed</span></a></li>
            <li<?php echo $search_active;?>><a href="/search"><i class="fa fa-search"></i> <span>Search</span></a></li>
